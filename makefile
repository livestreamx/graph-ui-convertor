...
CATALOG_ENV_EXTRA ?= $(strip \
	$(if $(CJM_CATALOG__DIAGRAM_EXCALIDRAW_ENABLED),-e CJM_CATALOG__DIAGRAM_EXCALIDRAW_ENABLED=$(CJM_CATALOG__DIAGRAM_EXCALIDRAW_ENABLED),) \
	$(if $(CJM_CATALOG__BUILDER_EXCLUDED_TEAM_IDS),-e CJM_CATALOG__BUILDER_EXCLUDED_TEAM_IDS=$(CJM_CATALOG__BUILDER_EXCLUDED_TEAM_IDS),) \
	$(if $(CJM_CATALOG__HEALTH_SAME_TEAM_OVERLAP_THRESHOLD_PERCENT),-e CJM_CATALOG__HEALTH_SAME_TEAM_OVERLAP_THRESHOLD_PERCENT=$(CJM_CATALOG__HEALTH_SAME_TEAM_OVERLAP_THRESHOLD_PERCENT),) \
	$(if $(CJM_CATALOG__HEALTH_CROSS_TEAM_OVERLAP_THRESHOLD_PERCENT),-e CJM_CATALOG__HEALTH_CROSS_TEAM_OVERLAP_THRESHOLD_PERCENT=$(CJM_CATALOG__HEALTH_CROSS_TEAM_OVERLAP_THRESHOLD_PERCENT),) \
)
