...
_RUSSIAN_TRANSLATIONS: Final[dict[str, str]] = {
    ...
    "Scene will be generated on demand from markup.": "Диаграмма будет сгенерирована по запросу из разметки.",
    "Scene file not found in {dir_name}. Run build-all before opening.": "Файл диаграммы не найден в {dir_name}. Запустите build-all перед открытием.",
    ...
    "If the scene does not load, import the downloaded file manually.": "Если диаграмма не загрузилась, импортируйте скачанный файл вручную.",
    ...
    "Build the catalog index to list available scenes. Run": "Соберите индекс каталога, чтобы увидеть доступные разметки. Выполните",
    "Try index API": "Проверить API индекса",
    "Opening {diagram_label}...": "Открытие {diagram_label}...",
    "Preparing the scene in local storage and redirecting.": "Подготавливаем диаграмму в localStorage и выполняем редирект.",
    "Failed to load the latest scene. Please retry.": "Не удалось загрузить последнюю версию диаграммы. Повторите попытку.",
    "Retry": "Повторить",
    "Reason": "Причина",
    ...
    "Running in background. This page updates automatically when analytics and diagrams are ready.": "Запущено в фоне. Эта страница обновится автоматически, когда аналитика и диаграммы будут готовы.",
    "Unable to build team graph. Try Merge again.": "Не удалось собрать командный граф. Попробуйте запустить объединение еще раз.",
    "Background merge finished. Analytics and diagram actions are ready below.": "Фоновое объединение завершено. Аналитика и действия с диаграммой доступны ниже.",
    "Selection is ready. Click Merge to start a background build.": "Выбор готов. Нажмите «Объединить», чтобы запустить фоновую сборку.",
    "Merge is still running. Analytics will appear here automatically.": "Объединение еще выполняется. Аналитика появится здесь автоматически.",
    "Merge is still running. Diagram actions unlock after completion.": "Объединение еще выполняется. Действия с диаграммой станут доступны после завершения.",
    "Failed to refresh merge status. Retrying...": "Не удалось обновить статус объединения. Повторяем попытку...",
    ...
    "Detected when a procedure has multiple starts, zero branch blocks, and those starts do not merge downstream.": "Срабатывает, когда в процедуре несколько стартов, blocks с ветвлением = 0 и эти старты не сходятся дальше по графу.",
    "No branches and no graph-completing end blocks": "Нет ветвлений и нет end-блоков, завершающих граф",
    "Same block used as start and end": "Один и тот же блок отмечен как старт и конец",
    "Detected when branch blocks = 0 and graph-completing end blocks = 0.": "Срабатывает, когда blocks с ветвлением = 0 и end-блоков, завершающих граф, = 0.",
    "Return-to-parent and postpone end blocks do not make a flow complete.": "End-блоки с возвратом в родителя и postpone не считаются завершением сценария.",
