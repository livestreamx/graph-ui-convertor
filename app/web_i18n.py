...
_RUSSIAN_TRANSLATIONS: Final[dict[str, str]] = {
    ...
    "Filter by group values inside each section.": "Фильтруйте по значениям групп в каждом разделе.",
    "scenes": "сцен",
    "Filter": "Фильтр",
    "Updated": "Обновлено",
    "View": "Открыть",
    ...
    "Service-level diagram": "Диаграмма уровня сервисов",
    ...
    "High-level service map: service nodes aggregate all selected service graphs.": "Верхнеуровневая карта сервисов: узлы агрегируют все выбранные сервисные графы.",
