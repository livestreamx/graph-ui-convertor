...
_RUSSIAN_TRANSLATIONS: Final[dict[str, str]] = {
    ...
    "Detected when one procedure marks the same block as both start and end.": "Срабатывает, когда в одной процедуре один и тот же блок отмечен и как start, и как end.",
