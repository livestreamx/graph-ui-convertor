...
- На карточках каталога выводятся четыре health-маркера:
  ...
  и лучшее кросс-командное пересечение. Для маркера валидности показывается breakdown по блокам
  (`start`, `branches`, `end кроме postpone`, `postpone`) вместо одного числового значения.
