...
- На карточках каталога выводятся четыре health-маркера:
  ...
  end-блоков кроме postpone (postpone-окончания не считаются завершением). Кейс, где в одной
  процедуре один и тот же блок отмечен и как start, и как end, показывается без отдельного пояснения.
